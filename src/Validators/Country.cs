...
namespace PlacetoPay.Redirection.Validators
{
    ...
    public class Country : BaseValidator
    {
        ...
        /// <summary>
        /// Get country codes as array.
        /// </summary>
        /// <returns>array</returns>
        public static Array CountryCodes()
        {
            return ISO2_ISO3.Keys.ToArray();
        }

        /// <summary>
        /// Check if is a valid country code.
        /// </summary>
        /// <param name="countryCode">string</param>
        /// <param name="iso">int</param>
        /// <returns>bool</returns>
        public static bool IsValidCountryCode(string countryCode, int iso = 2)
        {
            if (iso == 2)
            {
                return ISO2_ISO3.ContainsKey(countryCode);
            }
